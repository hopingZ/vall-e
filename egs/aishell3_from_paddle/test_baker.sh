...
CUDA_VISIBLE_DEVICES=3 python bin/infer_mandarin_phoneme.py \
  ...
  --model-name vallf \
  --audio-prompt prompts/000004.wav \
  --text-prompt "sil d eng4 x iao3 p ing2 v3 s a4 q ie4 er3 h uei4 u4 sp" \
  --output-dir infer/vallf_nano_baker_sp_epoch99 \
